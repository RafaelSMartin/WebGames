...
// 
/**
 * TODO: El MainMenu guarda la puntuación más alta y se crea con ella (añadelo al constructor)
 */
...
MainMenu.prototype.tick = function(dt) {
    ...
    /**
     * TODO: Escribe cuál es la puntuación más alta
     */
...
MainMenu.prototype.click = function(x, y) {
    ...
    /**
     * TODO: El juego se crea con la puntuación más alta actualmente
     */
    new SampleGame();
}
...
/**
 * TODO: El Game guarda la puntuación más alta y se crea con ella (añadelo al constructor)
 */
...
SampleGame.prototype.tick = function(dt) {
    ...
    if (this.time > 6)
      /**
       * TODO: Al volver al menú, comprueba si hemos mejorado la puntuación más alta para crear el menú
...
window.addEventListener("load", function() {
    ...
    /**
     * TODO: Comenzamos con la puntuación más alta a 0
     */
    new MainMenu();
});